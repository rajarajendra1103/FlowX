"use strict";var c=Object.defineProperty;var g=Object.getOwnPropertyDescriptor;var u=Object.getOwnPropertyNames;var p=Object.prototype.hasOwnProperty;var m=(e,t)=>{for(var o in t)c(e,o,{get:t[o],enumerable:!0})},x=(e,t,o,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of u(t))!p.call(e,n)&&n!==o&&c(e,n,{get:()=>t[n],enumerable:!(i=g(t,n))||i.enumerable});return e};var b=e=>x(c({},"__esModule",{value:!0}),e);var h={};m(h,{FlowXDevTools:()=>l});module.exports=b(h);var l={logs:[],initialized:!1,minimized:!1,visible:!1,init(){this.initialized||(this.initialized=!0,this.injectStyles(),this.createPanel(),this.bindEvents(),this.bindKeyboardShortcuts(),console.log("%c\u26A1 FlowX DevTools Mounted","color: #58a6ff; font-weight: bold; font-size: 1.1em;"))},injectStyles(){let e=document.createElement("style");e.id="flowx-devtools-styles",e.innerHTML=`
      #flowx-devtools-root {
        position: fixed;
        bottom: 76px;
        right: 20px;
