var l={logs:[],initialized:!1,minimized:!1,visible:!1,init(){this.initialized||(this.initialized=!0,this.injectStyles(),this.createPanel(),this.bindEvents(),this.bindKeyboardShortcuts(),console.log("%c\u26A1 FlowX DevTools Mounted","color: #58a6ff; font-weight: bold; font-size: 1.1em;"))},injectStyles(){let e=document.createElement("style");e.id="flowx-devtools-styles",e.innerHTML=`
      #flowx-devtools-root {
        position: fixed;
        bottom: 76px;
        right: 20px;
